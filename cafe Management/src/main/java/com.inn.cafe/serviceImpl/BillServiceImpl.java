...
public class BillServiceImpl implements BillService {
    ...
    private void addRows(PdfPTable table, Map<String, Object> data) {
        ...
        table.addCell((String) data.get("name")); // Assuming this is always a String
        table.addCell((String) data.get("category")); // Assuming this is always a String
        table.addCell(String.valueOf(data.get("quantity"))); // Changed to handle possible Integer or String
        table.addCell(String.valueOf(data.get("price"))); // Will convert to String
        table.addCell(String.valueOf(data.get("total"))); // Will convert to String
    }
